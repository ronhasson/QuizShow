var questionsList = [{
  ...
  {
    q_question: 'מהו אורכה של המדוזה הגדולה ביותר בעולם?',
    q_answers: [
      '30 מטר',
      '15 מטר',
      '2 מטר',
  ...
  {
    q_question: 'בעבר אנשים נהיו חולים ואפילו מתו ממה שחשבו שהיה אכילת עגבניות, ממה הם באמת מתו?',
    q_answers: [
      'הצלחות שאכלו עליהם הכילו עופרת',
      'שיטת השימור בפחיות לא הייתה טובה',
      'החומר הדברה היה רעיל ומסוכן',
      'הן נאכלו עם עובש עליהן'
    ],
    q_type: 'category',
    q_category: "אל תאכל את הירקות שלך",
    correct_answer: 'הצלחות שאכלו עליהם הכילו עופרת',
    done: false
  },
  {
    q_question: 'איזה מבין ההבאים אינו סוג של גל?',
    q_answers: [
      'גאות ושפל',
      'צונמי',
      'סייש',
    ...
    q_type: 'category',
    q_category: "גלים גלים של געגוע",
    correct_answer: 'טונמי',
    done: false
  },
  {
